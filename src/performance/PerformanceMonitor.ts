...
export class PerformanceMonitor {
    ...
    private startMonitoringLoop(): void {
        ...
        const loop = () => {
            ...
            if (this.frameCount % 60 === 0) { // update roughly every 60 frames
            ...
            this.fpsIntervalId = window.setInterval(() => {
                ...
                if (elapsed >= 1000) {
                    ...
                    if (this.currentSession) {
                        ...
                        this.currentSession.averageFPS = this.currentSession.fpsHistory.reduce((a, b) => a + b, 0) / this.currentSession.fpsHistory.length;
                    }
