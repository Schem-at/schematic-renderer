...
const resourcePackLinks = [
	"http://localhost:8079/https://vanillatweaks.net/download/VanillaTweaks_r609473.zip",
	"http://localhost:8079/https://www.curseforge.com/api/v1/mods/457153/files/5008188/download",
];

async function getAllResourcePackBlobs(ressourcePackLinks: string[]) {
...
getAllResourcePackBlobs(resourcePackLinks).then((resourcePackBlobs) => {
